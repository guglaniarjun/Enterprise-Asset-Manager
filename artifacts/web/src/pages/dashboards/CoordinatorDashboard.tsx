...
export default function CoordinatorDashboard() {
  ...
  const { data: dashboard, isLoading } = useGetCoordinatorDashboard(
    { date: today },
    {
      query: {
  ...
  const handleVerify = (id: number) => {
    verifyLog.mutate(
      { id, data: { coordinatorRemarks: "" } },
      {
        onSuccess: () => {
          toast({ title: "Log verified" });
          queryClient.invalidateQueries({
            queryKey: getGetCoordinatorDashboardQueryKey({ date: today }),
          });
        },
        onError: (err) => {
  ...
  const handleReject = () => {
    ...
    rejectLog.mutate(
      { id: selectedLogId, data: { coordinatorRemarks: remarks } },
      {
        onSuccess: () => {
        ...
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={!remarks || rejectLog.isPending}
            >
              Confirm Reject
            </Button>
          </DialogFooter>
