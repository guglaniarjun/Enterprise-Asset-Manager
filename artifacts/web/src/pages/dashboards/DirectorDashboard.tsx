...
import {
  useGetComplianceAnalytics,
  useGetDisciplineAnalytics,
...
export default function DirectorDashboard() {
  ...
  const { data: discipline, isLoading: isDisciplineLoading } =
    useGetDisciplineAnalytics(
      {
        dateFrom: format(
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          <CardHeader>
            <CardTitle>Compliance by Class (7-day)</CardTitle>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Discipline Issues by Class (30-day)</CardTitle>
          </CardHeader>
          <CardContent className="h-[300px]">
            {isDisciplineLoading ? (
              <Skeleton className="w-full h-full" />
