...
export default function Compliance() {
  ...
  const { data, isLoading } = useGetComplianceAnalytics(
    { dateFrom, dateTo },
    {
      query: {
        ...
        <CardContent>
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm text-muted-foreground">
              {(data?.summary as any)?.totalSubmitted || 0} /{" "}
              {(data?.summary as any)?.totalExpected || 0} expected logs
            </span>
          </div>
