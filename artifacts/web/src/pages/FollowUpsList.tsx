...
export default function FollowUpsList() {
  ...
  const query = useQuery({
    ...
    queryFn: () =>
      listFollowUps(
        tab === "Overdue" ? { status: "Pending" } : { status: tab },
      ),
  });
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Scheduled action items tied to students, alerts and events.
          </p>
        </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div className="grid md:grid-cols-2 gap-3">
              <div>
                ...
                <Input
                  ...
                  placeholder="Call parent / Counselling session"
                />
              </div>
              <div>
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button
                disabled={!form.title || !form.scheduledFor || create.isPending}
            ...
            <Table>
              ...
              <TableBody>
                {rows.map((r) => (
                  <TableRow
                    key={r.id}
                    className={r.status !== "Pending" ? "opacity-60" : ""}
                  >
                      ...
                      {r.status === "Pending" && (
                        <>
                          ...
                          <Button
                            ...
                            disabled={complete.isPending}
                            onClick={() =>
                              complete.mutate({ id: r.id, status: "Skipped" })
                            }
                          >
                            Skip
                          </Button>
