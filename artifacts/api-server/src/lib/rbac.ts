...
export const RBAC = {
  ...
  ADMIN_AND_PRINCIPAL: [ROLES.SUPER_ADMIN, ROLES.TENANT_ADMIN, ROLES.PRINCIPAL] as string[],
  LEADERSHIP: [ROLES.SUPER_ADMIN, ROLES.TENANT_ADMIN, ROLES.DIRECTOR, ROLES.PRINCIPAL] as string[],
